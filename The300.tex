...
passcontext,
transparent,
addresource=plots/NewMDCLUSTER0017.mp4,
flashvars={source=plots/NewMDCLUSTER0017.mp4}
]{\includegraphics[width=0.6\linewidth]{G3X-17-image.pdf}}{VPlayer.swf}

    % \movie[loop,autostart]{\includegraphics[width=0.6\textwidth]{G3X-17-image.pdf}}{plots/NewMDCLUSTER0017.mp4}
  \end{center}
...
\begin{frame}{The cluster density profiles: Mostoghiu et al. 2018.}
  ...
  \vspace{-0.5cm}
  \begin{figure}
    \includegraphics[width=0.5\linewidth]{LeBrun18}
    \vspace{-0.5cm}
  \end{figure}
    \begin{textblock}{0.3}(0.01,0.4)
      {Density profiles. Le Brun et al. 2018}
    \end{textblock}
  }
  \only<2>{
  \begin{figure}
    \includegraphics[width=\linewidth]{Mostoghiu-density-relax.png}
    \caption{Galaxy cluster density profiles sepearated into relax and unrelax sample. Mostoghiu et al. 2018}
  \end{figure}}
  \only<3>{
  \begin{figure}
    \includegraphics[width=\linewidth]{Mostoghiu-formation-time.png}
    \caption{Formation time of relaxed and unrelaxed galaxies. Mostoghiu et al. 2018}
  \end{figure} }
    \only<4>{
  \begin{figure}
    \includegraphics[width=\linewidth]{Mostoghiu-density-foramtiontime.png}
    \caption{Galaxy cluster density profiles sepearated by formation time. Mostoghiu et al. 2018}
  \end{figure}}
    \only<5>{
  \begin{figure}
    \includegraphics[width=\linewidth]{Mostoghiu-density-gas.png}
    \caption{Gas density profiles. Mostoghiu et al. 2018}
  \end{figure}}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
      ...
      \item \hyperlink{Wang}{\beamerbutton{the environment paper}} (Wang et al. 2018)  mainly talks about the differences between cluster and other environments.
      \item \hyperlink{Mostoghiu}{\beamerbutton{the density profile paper}} (Mostoghiu et al. 2018) studies the self-similarity of the density profiles in galaxy clusters.
      \item \hyperlink{Arthur}{\beamerbutton{\alert{The phase-space paper}}} (Arthur et al. to be sumbitted) investigates the phase-space in and around galaxy clusters.
      \item \hyperlink{Li}{\beamerbutton{The physical density paper}} (Li et al. in final prep.) try to compare and understand the observable profiles in galaxy clusters.
  \end{itemize}
\end{frame}
...
\end{frame}
\begin{frame}{The phase-sapce distribution}
  \only<1>{
  \begin{figure}
    \includegraphics[width=\linewidth]{Arthur-calculation-explaination.png}
    \caption{The phase-sapce distribution example. Stacking...}
  \end{figure}}
  \only<2>{
  \begin{figure}
    \includegraphics[width=0.58\linewidth]{Arthur-phase-space.png}\vspace{-0.4cm}
    \caption{The phase-sapce distributions.}
  \end{figure}}
    \only<3>{
  \begin{figure}
    \includegraphics[width=\linewidth]{Arthur-phase-space-halo-subhalo.png}\vspace{-0.6cm}
    \caption{The phase-sapce distribution separated by halo and subhalo.}
  \end{figure}}
      \only<4>{
  \begin{figure}
    \includegraphics[width=0.7\linewidth]{Arthur-ram-presure.png}\vspace{-0.6cm}
    \caption{The ram pressure phase distribution.}
  \end{figure}}
      \only<5>{
  \begin{figure}
    \includegraphics[width=0.8\linewidth]{Arthur-ram-halo-subhalo.png}
  \end{figure}
  \begin{textblock}{0.12}(0.01,0.2)
    The ram pressure phase distribution separated by halo and subhalo.
  \end{textblock}}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
      ...
      \item \hyperlink{Wang}{\beamerbutton{the environment paper}} (Wang et al. 2018)  mainly talks about the differences between cluster and other environments.
      \item \hyperlink{Mostoghiu}{\beamerbutton{the density profile paper}} (Mostoghiu et al. 2018) studies the self-similarity of the density profiles in galaxy clusters.
      \item \hyperlink{Arthur}{\beamerbutton{The phase-space paper}} (Arthur et al. to be sumbitted) investigates the phase-space in and around galaxy clusters.
...
\begin{frame}{The observable profiles}
  \only<1>{
  \begin{figure}
    \includegraphics[width=0.8\linewidth]{Li-age-profile.png}\vspace{-0.5cm}
    \caption{The stellar age profile.}
  \end{figure}}
\only<2>{
\begin{figure}
\includegraphics[width=0.8\linewidth]{Li-Starmetal-profiel.png}\vspace{-0.5cm}
\caption{The stellar metal profile.}
\end{figure}}
  \only<3>{
  \begin{figure}
    \includegraphics[width=0.8\linewidth]{Li-temperature-profile.png}\vspace{-0.5cm}
    \caption{The gas temperature profile.}
  \end{figure}}
    \only<4>{
  \begin{figure}
    \includegraphics[width=0.8\linewidth]{Li-gasmetal-profile.png}\vspace{-0.5cm}
    \caption{The gas metallicity profile.}
  \end{figure}}
\end{frame}
